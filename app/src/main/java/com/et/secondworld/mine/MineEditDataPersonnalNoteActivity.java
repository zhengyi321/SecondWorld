 ...
 * @Date 2020/5/7
 **/
public class MineEditDataPersonnalNoteActivity extends AppCompatActivity {
...
//        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
    ...
    private void getIntentData(){
        ...
        String personnalNote = intent.getStringExtra("personnalnote");
    ...
    private void saveData(){
        ...
        map.put("personnalnote",personnalnote);
        mineNetWork.updatePersonnalNoteFromNet(map, new Observer<UpdatePersonnalNoteBean>() {
            @Override
            ...
            @Override
            public void onNext(UpdatePersonnalNoteBean updatePersonnalNoteBean) {
                String personnalNote = updatePersonnalNoteBean.getPersonnalnote();
                xcCacheManager.writeCache(xcCacheSaveName.personnalNote,personnalNote);
                Intent i = new Intent();
