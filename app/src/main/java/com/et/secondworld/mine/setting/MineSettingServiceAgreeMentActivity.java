 ...
 * @Date 2020/4/16
 **/
public class MineSettingServiceAgreeMentActivity extends AppCompatActivity {

    @OnClick(R.id.rly_mine_setting_service_agreement_back)
    public void rlyMineSettingServiceAgreementBackOnclick(){
        finish();
    }
    ...
    protected void onCreate(Bundle bundle){
        ...
        setContentView(R.layout.activity_mine_setting_service_agreement);
        init();
    }
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    private void init(){
