 ...
 * @Date 2020/4/16
 **/
public class MineSettingSercetPolicyActivity extends AppCompatActivity {

    @OnClick(R.id.rly_mine_setting_secret_policy_back)
    public void rlyMineSettingSecretPolicyBackOnclick(){
        finish();
    }
    ...
    protected void onCreate(Bundle bundle){
        ...
        setContentView(R.layout.activity_mine_setting_secret_policy);
        init();
    }
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    private void init(){
