 ...
 * @Date 2020/4/16
 **/
public class MineSettingMessageNoticeActivity extends AppCompatActivity {

    @BindView(R.id.rly_mine_setting_message_notice_back)
    RelativeLayout rlyMineSettingMessageNoticeBack;
    @OnClick(R.id.rly_mine_setting_message_notice_back)
    public void rlyMineSettingMessageNoticeBackOnclick(){
        finish();
    }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_mine_setting_message_notice);
        init();
    }
