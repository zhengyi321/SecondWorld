 ...
 * @Date 2020/5/7
 **/
public class MineEditDataTradeActivity extends AppCompatActivity {
...
//        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
    ...
    private void getIntentData(){
        ...
        String personnalNote = intent.getStringExtra("trade");
        tvMineEditDataPersonnalNoteTitle.setText("修改行业");
        tvMineEditDataPersonnalNoteNick.setText("行业");
        etMineEditDataPersonnalNote.setHint("填写行业");
    ...
    private void saveData(){
        ...
        map.put("trade",personnalnote);
        mineNetWork.saveEditDataTradeToNet(map, new Observer<SaveEditDataBean>() {
            @Override
            ...
            public void onNext(SaveEditDataBean updatePersonnalNoteBean) {
                String personnalNote = updatePersonnalNoteBean.getTrade();
                xcCacheManager.writeCache(xcCacheSaveName.trade,personnalNote);
                Intent i = new Intent();
