...
//            } else
            ...
            format = String.format(" %01d 时 %01d 分 %01d 秒",  hours, minutes, seconds);
...
//            mTimeUnits[1][0] = mBeforeIndex + String.format("%01d", days).length() + 3;
            ...
            mTimeUnits[2][0] = mBeforeIndex +  String.format("%01d", hours).length() + 6;
//            mTimeUnits[2][0] = mBeforeIndex + String.format("%01d", days).length() + String.format("%01d", hours).length() + 6;
            ...
            mTimeUnits[3][0] = mBeforeIndex +  String.format("%01d", hours).length() + String.format("%01d", minutes).length() + 9;
