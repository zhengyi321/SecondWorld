...
import com.et.secondworld.widget.timeselect.adapter.WheelAdapter;
import com.et.secondworld.widget.timeselect.listener.OnItemSelectedListener;
...
//                    Object selected = adapter.indexOf(visibles[counter]);
                    Log.d("wheelView1",preSelectedItem+"");
//                    int zero = selected.toString().indexOf("0");
//                    String item ="";
//                    if(zero == 1) {
//                        item = selected.toString().substring(1,2);
//                    }else {
//                        item = selected.toString();
//                    }
//                    int preSelectedItem = Integer.parseInt(item);
                    if(preSelectedItem != -1){
//                    if(preSelectedItem.toString().equals("-1")){
