 ...
 */
public class NormalImagePreActivity extends BaseActivity {
    ...
    protected int bindLayout() {
        return R.layout.activity_normal_pre_image;
    }
...
//                updateSelectButton(mMediaFileList.get(position).getPath());
        ...
        mLlPreSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ConfigManager.getInstance().isSingleType()) {
                    ...
                    if (!selectPathList.isEmpty()) {
                        ...
                        if (!SelectionManager.isCanAddSelectionPaths(mMediaFileList.get(mViewPager.getCurrentItem()), selectPathList.get(0))) {
                            //类型不同
                            Toast.makeText(NormalImagePreActivity.this, getString(R.string.single_type_choose), Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                }
                ...
                if (addSuccess) {
                    ...
                    Toast.makeText(NormalImagePreActivity.this, String.format(getString(R.string.select_image_max), SelectionManager.getInstance().getMaxCount()), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mIvPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = FileProvider.getUriForFile(NormalImagePreActivity.this, ImagePickerProvider.getFileProviderName(NormalImagePreActivity.this), new File(mMediaFileList.get(mViewPager.getCurrentItem())));
