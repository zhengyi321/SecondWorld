...
import com.et.secondworld.widget.textview.ZTextViewClickUtil;
...
public class AutoVerticalScrollTextViewUtil {
    ...
    private ArrayList<CharSequence> mDatas = new ArrayList();
    private CharSequence title;
    private AutoVerticalScrollTextViewUtil.OnMyClickListener onMyClickListener;

    public AutoVerticalScrollTextViewUtil(AutoVerticalScrollTextView textView, ArrayList<CharSequence> datas) {
        this.mDatas = datas;
