...
import com.et.secondworld.widget.timeselect.lib.ProCityAreaWheelView;
import com.et.secondworld.widget.timeselect.listener.CustomListener;
import com.et.secondworld.widget.timeselect.view.ProCityAreaBasePickerView;
import com.et.secondworld.widget.timeselect.view.ProCityAreaWheelOptions;
import com.et.secondworld.widget.timeselect.view.ProTradeWheelOptions;
 ...
 */
public class TradeOptionsPickerView<T> extends ProCityAreaBasePickerView implements View.OnClickListener {

    ProTradeWheelOptions<T> wheelOptions;
...
//    private int option3;
    ...
    //构造方法
    public TradeOptionsPickerView(Builder builder) {
...
//        this.option3 = builder.option3;
    ...
    public static class Builder {
        private int layoutRes = R.layout.trade_pickerview_options;
        private CustomListener customListener;
...
//            this.option3 = option3;
        ...
        public TradeOptionsPickerView build() {
            return new TradeOptionsPickerView(this);
        }
    }
...
//            btnCancel.setTextColor(Color_Cancel == 0 ? pickerview_timebtn_nor : Color_Cancel);
        ...
        wheelOptions = new ProTradeWheelOptions(optionsPicker, linkage);
        wheelOptions.setTextContentSize(Size_Content);
        wheelOptions.setLabels(label1, label2, "label3");
        wheelOptions.setCyclic(cyclic1, cyclic2, false);
