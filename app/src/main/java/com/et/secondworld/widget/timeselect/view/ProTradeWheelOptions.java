...
import com.et.secondworld.widget.timeselect.adapter.ProCityAreaArrayWheelAdapter;
...
public class ProTradeWheelOptions<T> {
    private View view;
...
//    private List<T> N_mOptions3Items;
    ...
    public ProTradeWheelOptions(View view, Boolean linkage) {
        super();
