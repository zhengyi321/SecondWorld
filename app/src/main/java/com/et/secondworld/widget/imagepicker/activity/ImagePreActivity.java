...
import com.et.secondworld.widget.imagepicker.adapter.ImagePreViewAdapter;
...
public class ImagePreActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        mTvPreSelect = findViewById(R.id.tv_item_nums);
    }
...
//        mMediaFileList.add(new MediaFile());
//        mPosition = 0;
        mPosition = getIntent().getIntExtra(IMAGE_POSITION, 0);
        mTvTitle.setText(String.format("%d/%d", mPosition + 1, mMediaFileList.size()));
        mImagePreViewAdapter = new ImagePreViewAdapter(this, mMediaFileList,mTvCommit,mIvPreCheck, mTvPreSelect);
    ...
    private void updateSelectButton(String imagePath) {
        ...
        int selectCount = SelectionManager.getInstance().getSelectPaths().size();
        if (isSelect) {
            mIvPreCheck.setImageDrawable(getResources().getDrawable(R.mipmap.selected));
...
//            mIvPreCheck.setImageDrawable(getResources().getDrawable(R.mipmap.icon_image_checked));
            ...
            mIvPreCheck.setImageDrawable(getResources().getDrawable(R.mipmap.oval));
