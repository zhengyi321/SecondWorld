...
/**
 * Created by Duqianlong on 2018/11/27.
 * https://blog.csdn.net/qq_36488374/article/details/84560469
 */

public class MyZoomScrollView extends ScrollView {
...
//                    zoomView = vg1.getChildAt(0);
                    ViewGroup vg2 =(ViewGroup)  vg1.getChildAt(0);
                    if (vg2.getChildAt(0) != null) {
                        zoomView = vg2.getChildAt(0);
                    }
//                    dropZoomView = vg1.getChildAt(0);
                }
//                dropZoomView = vg.getChildAt(0);
            }
...
//        ((MarginLayoutParams) layoutParams).setMargins(-(layoutParams.width - zoomViewWidth) / 2, 0, 0, 0);
    ...
    public void getfresh(Mycallback mycallback) {
