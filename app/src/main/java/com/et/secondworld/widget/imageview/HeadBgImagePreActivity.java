 ...
 */
public class HeadBgImagePreActivity extends BaseActivity {
...
//                updateSelectButton(mMediaFileList.get(position).getPath());
        ...
        mLlPreSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ConfigManager.getInstance().isSingleType()) {
                    ...
                    if (!selectPathList.isEmpty()) {
                        ...
                        if (!SelectionManager.isCanAddSelectionPaths(mMediaFileList.get(mViewPager.getCurrentItem()), selectPathList.get(0))) {
                            //类型不同
                            Toast.makeText(HeadBgImagePreActivity.this, getString(R.string.single_type_choose), Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                }
                ...
                if (addSuccess) {
                    ...
                    Toast.makeText(HeadBgImagePreActivity.this, String.format(getString(R.string.select_image_max), SelectionManager.getInstance().getMaxCount()), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mIvPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = FileProvider.getUriForFile(HeadBgImagePreActivity.this, ImagePickerProvider.getFileProviderName(HeadBgImagePreActivity.this), new File(mMediaFileList.get(mViewPager.getCurrentItem())));
...
//                Toast.makeText(getBaseContext(),""+e,Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onNext(SaveEditDataBean saveEditDataBean) {
                Log.d("zz22",saveEditDataBean.getBg());
