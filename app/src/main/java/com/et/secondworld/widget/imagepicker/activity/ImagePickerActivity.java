package com.et.secondworld.widget.imagepicker.activity;
...
import com.et.secondworld.widget.imagepicker.adapter.ImageFoldersAdapter;
import com.et.secondworld.widget.imagepicker.adapter.ImagePickerAdapter;
import com.et.secondworld.widget.imagepicker.data.MediaFile;
import com.et.secondworld.widget.imagepicker.data.MediaFolder;
import com.et.secondworld.widget.imagepicker.executors.CommonExecutor;
...
import com.et.secondworld.widget.imagepicker.task.ImageLoadTask;
import com.et.secondworld.widget.imagepicker.task.MediaLoadTask;
import com.et.secondworld.widget.imagepicker.task.VideoLoadTask;
import com.et.secondworld.widget.imagepicker.utils.DataUtil;
import com.et.secondworld.widget.imagepicker.utils.MediaFileUtil;
import com.et.secondworld.widget.imagepicker.utils.PermissionUtil;
import com.et.secondworld.widget.imagepicker.utils.Utils;
import com.et.secondworld.widget.imagepicker.view.ImageFolderPopupWindow;
...
public class ImagePickerActivity extends BaseActivity implements ImagePickerAdapter.OnItemClickListener, ImageFoldersAdapter.OnImageFolderChangeListener {
    ...
    protected void initConfig() {
        ...
        if (mImagePaths != null && !mImagePaths.isEmpty()) {
            Log.d("aaaa111",mImagePaths.size()+"");
...
//        }
    ...
    protected void initListener() {
        ...
        findViewById(R.id.rly_actionBar_back).setOnClickListener(new View.OnClickListener() {
            @Override
...
//            int selectCount = SelectionManager.getInstance().getSelectPaths().size();
            ...
            if (addSuccess) {
//                mImagePickerAdapter.Nums = selectCount;
//                mImagePickerAdapter.selectnums = 0;
                mImagePickerAdapter.isResume = 0;
...
//
//            mImagePickerAdapter.Nums = selectCount;
        mImagePickerAdapter.isResume = 1;
        mImagePickerAdapter.notifyDataSetChanged();
        updateCommitButton();
    }
