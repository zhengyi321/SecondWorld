...
public class TradeNetWork extends BaseNetWork {
    ...
    private interface NetService{
        ...
        @FormUrlEncoded
        @POST("trade/gettrade")
        Observable<GetTradeBean> getTradeFromNet(@FieldMap Map<String, Object> paramMap);
        /*获取广告*/
        /*获取广告*/
        @FormUrlEncoded
    ...
    public  void getTradeFromNet(Map<String, Object> paramMap,Observer<GetTradeBean> observer){
        setSubscribe(service.getTradeFromNet(paramMap),observer);
    }
