...
public class SpreadNetWork extends BaseNetWork {
    ...
    private interface NetService{
        ...
        /*开通店铺*/
        @FormUrlEncoded
        @POST("spread/articlespread")
        Observable<BaseBean> spreadToNet(@FieldMap Map<String, Object> paramMap);
        /*开通店铺*/
        /*开通店铺*/
        @FormUrlEncoded
        @POST("spread/getspreadtime")
        Observable<ShopTimesPayTimeBean> getShopTimesPayTimeFromNet(@FieldMap Map<String, Object> paramMap);
        /*开通店铺*/
        /*开通店铺*/
        @FormUrlEncoded
        @POST("spread/spreadtop")
        Observable<BaseBean> spreadTopToNet(@FieldMap Map<String, Object> paramMap);
        /*开通店铺*/
        /*开通店铺*/
        @FormUrlEncoded
        @POST("map/getverticaltitle")
        Observable<GetMapVerticalTitleListBean> getMapVerticalTitleFromNet(@FieldMap Map<String, Object> paramMap);
        /*开通店铺*/
        /*开通店铺*/
//        @FormUrlEncoded
//        @POST("shop/getmyshop")
...
//        获取保存信息
    ...
    public  void spreadToNet(Map<String,Object> paramMap,Observer<BaseBean> observer){
        setSubscribe(service.spreadToNet(paramMap),observer);
    }
    public  void getShopTimesPayTimeFromNet(Map<String,Object> paramMap,Observer<ShopTimesPayTimeBean> observer){
        setSubscribe(service.getShopTimesPayTimeFromNet(paramMap),observer);
    }
    public  void spreadTopToNet(Map<String,Object> paramMap,Observer<BaseBean> observer){
        setSubscribe(service.spreadTopToNet(paramMap),observer);
    }
    public  void getMapVerticalTitleFromNet(Map<String,Object> paramMap,Observer<GetMapVerticalTitleListBean> observer){
        setSubscribe(service.getMapVerticalTitleFromNet(paramMap),observer);
    }
