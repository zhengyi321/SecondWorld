...
public class GuanZhuFansNetWork extends BaseNetWork {
    ...
    private interface NetService{
        ...
        @FormUrlEncoded
        @POST("follow/getfans")
        Observable<GetFansBean> getFansFromNet(@FieldMap Map<String, String> paramMap);
        /*获取粉丝*/
        /*关注粉丝*/
        @FormUrlEncoded
        @POST("follow/addfans")
        ...
        /*获取关注*/
        @FormUrlEncoded
        @POST("follow/getguanzhushop")
        Observable<GetGuanZhuBean> getGuanZhuShopFromNet(@FieldMap Map<String, String> paramMap);
        /*获取关注*/
        /*取消关注*/
        @FormUrlEncoded
...
//        获取保存信息
    ...
    public  void getFansFromNet(Map<String,String> paramMap,Observer<GetFansBean> observer){
        setSubscribe(service.getFansFromNet(paramMap),observer);
    }
    ...
    public  void getGuanZhuShopFromNet(Map<String,String> paramMap,Observer<GetGuanZhuBean> observer){
        setSubscribe(service.getGuanZhuShopFromNet(paramMap),observer);
    }
