...
public class CollectVillageNetWork extends BaseNetWork {
    ...
    private interface NetService{
        ...
        /*开通店铺*/
        @FormUrlEncoded
        @POST("village/errorvillageadd")
        Observable<BaseBean> addErrorVillageToNet(@FieldMap Map<String, Object> paramMap);
        /*开通店铺*/
        /*开通店铺*/
        @FormUrlEncoded
        @POST("village/collectvillageadd")
        Observable<BaseBean> addCollectVillageToNet(@FieldMap Map<String, Object> paramMap);
        /*开通店铺*/
        /*开通店铺*/
        @FormUrlEncoded
        @POST("village/geterrorvillage")
        Observable<BaseBean> getErrorVillageFromNet(@FieldMap Map<String, Object> paramMap);
        /*开通店铺*/
        /*开通店铺*/
        @FormUrlEncoded
        @POST("village/getcollectvillage")
        Observable<GetCollectVillageListBean> getCollectVillageFromNet(@FieldMap Map<String, Object> paramMap);
        /*开通店铺*/
        /*开通店铺*/
        @FormUrlEncoded
        @POST("village/updatecollectvillageselect")
        Observable<BaseBean> updateCollectVillageSelectToNet(@FieldMap Map<String, Object> paramMap);
        /*开通店铺*/
        /*开通店铺*/
//        @FormUrlEncoded
...
//        获取保存信息
    ...
    public  void addErrorVillageToNet(Map<String,Object> paramMap,Observer<BaseBean> observer){
        setSubscribe(service.addErrorVillageToNet(paramMap),observer);
    }
    public  void addCollectVillageToNet(Map<String,Object> paramMap,Observer<BaseBean> observer){
        setSubscribe(service.addCollectVillageToNet(paramMap),observer);
    }
    public  void getErrorVillageFromNet(Map<String,Object> paramMap,Observer<BaseBean> observer){
        setSubscribe(service.getErrorVillageFromNet(paramMap),observer);
    }
    public  void getCollectVillageFromNet(Map<String,Object> paramMap,Observer<GetCollectVillageListBean> observer){
        setSubscribe(service.getCollectVillageFromNet(paramMap),observer);
    }
    public  void updateCollectVillageSelectToNet(Map<String,Object> paramMap,Observer<BaseBean> observer){
        setSubscribe(service.updateCollectVillageSelectToNet(paramMap),observer);
    }
