...
public class NoticeNetWork extends BaseNetWork {
    ...
    private interface NetService{
        ...
        /*开通店铺*/
        @FormUrlEncoded
        @POST("notice/getimportantnotice")
        Observable<GetImportantNoticeBean> getImportantNoticeFromNet(@FieldMap Map<String, Object> paramMap);
        /*开通店铺*/
        /*开通店铺*/
        @FormUrlEncoded
...
//        获取保存信息
    ...
    public  void getImportantNoticeFromNet(Map<String,Object> paramMap,Observer<GetImportantNoticeBean> observer){
        setSubscribe(service.getImportantNoticeFromNet(paramMap),observer);
    }
