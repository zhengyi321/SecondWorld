...
public class SearchNetWork extends BaseNetWork {
    ...
    private interface NetService{
        ...
        /*开通店铺*/
        @FormUrlEncoded
        @POST("search/getvillage")
        Observable<VillageListBean> getVillageFromNet(@FieldMap Map<String, Object> paramMap);
        /*开通店铺*/
        /*开通店铺*/
        @FormUrlEncoded
        @POST("search/getshop")
        Observable<VillageListBean> getShopFromNet(@FieldMap Map<String, Object> paramMap);
        /*开通店铺*/
        /*开通店铺*/
        @FormUrlEncoded
        @POST("search/getshopbyplace")
        Observable<VillageListBean> getShopByPlaceFromNet(@FieldMap Map<String, Object> paramMap);
        /*开通店铺*/
        /*开通店铺*/
//        @FormUrlEncoded
//        @POST("shop/getmyshop")
...
//        获取保存信息
    ...
    public  void getVillageFromNet(Map<String,Object> paramMap,Observer<VillageListBean> observer){
        setSubscribe(service.getVillageFromNet(paramMap),observer);
    }
    public  void getShopFromNet(Map<String,Object> paramMap,Observer<VillageListBean> observer){
        setSubscribe(service.getShopFromNet(paramMap),observer);
    }
    public  void getShopByPlaceFromNet(Map<String,Object> paramMap,Observer<VillageListBean> observer){
        setSubscribe(service.getShopByPlaceFromNet(paramMap),observer);
    }
