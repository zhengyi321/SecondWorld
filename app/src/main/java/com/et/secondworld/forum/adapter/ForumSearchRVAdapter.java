 ...
 * @Date 2020/4/7
 **/
public class ForumSearchRVAdapter extends RecyclerView.Adapter<ForumSearchRVAdapter.OneViewHolder> {
...
//    private LinearLayout llyForumMark;
    ...
    private String type = "";
    public ForumSearchRVAdapter(List<GetForumBean.ListBean> dataList1,String managetype){
        dataList = dataList1;
...
//        this.llyForumMark = llyForumMark;
    ...
    public OneViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ForumSearchRVAdapter.OneViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_forum_search_rv_item, parent, false));
    }
...
//        TextView tvForumRVItemComments3;
        ...
        @BindView(R.id.lly_forum_search_account)
        LinearLayout llyForumSearchAccount;
        @BindView(R.id.civ_forum_search_rv_item_head)
        CircleImageView civForumSearchRVItemHead;
        @BindView(R.id.tv_forum_search_rv_item_nick)
        TextView tvForumSearchRVItemNick;
        @BindView(R.id.tv_forum_search_rv_item_accountid)
        TextView tvForumSearchRVItemAccountid;
        ...
        public void llyForumRVItemOnclick(){
            if(System.currentTimeMillis() - clickTime > 2000) {
                ...
                if(type.equals("0")) {
                    ...
                    intent.putExtra("articleaccount",id);
...
//            intent.putExtra("title",title);
        ...
        void setData(Object data,int position) {
            pos = position;
            if(type.equals("0")){
                llyForumSearchAccount.setVisibility(View.VISIBLE);
                ...
                String head = dataList.get(position).getHead();
                 id = dataList.get(position).getThirdid();
                tvForumSearchRVItemNick.setText(nick);
                Glide.with(v).load(head).apply(new RequestOptions().circleCrop().fallback(R.mipmap.imghead)
                        .error(R.mipmap.imghead)).into(civForumSearchRVItemHead);
                tvForumSearchRVItemAccountid.setText("账号:"+id);
            }else {

                llyForumSearchAccount.setVisibility(View.GONE);
           /* if(isNoMoreData){
