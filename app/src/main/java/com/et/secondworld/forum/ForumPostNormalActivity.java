 ...
 * @Date 2020/4/23
 **/
public class ForumPostNormalActivity extends AppCompatActivity implements LocationSource, TencentLocationListener {
        ...
        articleNetWork.getTempArticleFromNet(map, new Observer<GetTempArticleBean>() {
            ...
            public void onNext(GetTempArticleBean getTempArticleBean) {
                if(getTempArticleBean.getIssuccess().equals("1")){
                    ...
                    etForumPostContent.setText(content.trim());
...
//                            Toast.makeText(this,""+item.getId(),Toast.LENGTH_LONG).show();
    ...
    private void selectImgActivity(){
       ...
       /* Matisse.from(this)
                ...
                .countable(true)
                .maxSelectable(4)//选择图片的最大数量限制
                .capture(true)//启用相机
                .captureStrategy(new CaptureStrategy(true,"com.et.secondworld.provider"))//自定义FileProvider
                ...
                .forResult(SELECT_IMAGE_REQUEST_IMAGES);*/
