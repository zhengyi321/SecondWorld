...
import com.et.secondworld.huanxin.model.EaseDingMessageHelper;
import com.et.secondworld.huanxin.utils.EaseCommonUtils;
import com.et.secondworld.huanxin.utils.EaseUserUtils;
import com.et.secondworld.huanxin.widget.EaseAlertDialog;
import com.et.secondworld.huanxin.widget.EaseChatExtendMenu;
import com.et.secondworld.huanxin.widget.EaseChatInputMenu;
import com.et.secondworld.huanxin.widget.EaseChatMessageList;
import com.et.secondworld.huanxin.widget.EaseVoiceRecorderView;
import com.et.secondworld.huanxin.widget.chatrow.EaseCustomChatRowProvider;
...
//                startActivityForResult(new Intent(getActivity(), EaseBaiduMapActivity.class), REQUEST_CODE_MAP);
    ...
    protected void selectPicFromCamera() {
        ...
        //进行权限的判断
        boolean hasPermission = PermissionUtil.checkPermission(getContext());
        if (!hasPermission) {
            ActivityCompat.requestPermissions(getActivity(), new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_PERMISSION_CAMERA_CODE);
        } else {
