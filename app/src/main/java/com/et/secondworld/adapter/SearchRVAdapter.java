 ...
 * @Date 2020/4/7
 **/
public class SearchRVAdapter extends RecyclerView.Adapter<SearchRVAdapter.OneViewHolder> {
    ...
    public OneViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SearchRVAdapter.OneViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_search_rv_item, parent, false));
    }
